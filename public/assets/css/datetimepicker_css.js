...
var imageFilesPath = "../_ext/images2/";
...
var WeekDayName1 = ["Domenica", "Lunedì", "Martedì", "Mercoledì", "Giovedì", "Venerdì", "Sabato"];
var WeekDayName2 = ["Lunedì", "Martedì", "Mercoledì", "Giovedì", "Venerdì", "Sabato", "Domenica"];
...
{ //Generate table cell with value
	...
	if (PValue !== "")
	{
		if (PClickable === true) {
		    ...
		    else { PCellStr = "<td class='calTD' style='text-align:center;cursor:pointer;background-color:" + pColor + "' onmouseover='changeBorder(this, 0);' onmouseout=\"changeBorder(this, 1, '" + pColor + "');\" onClick=\"callback('" + Cal.Ctrl + "','" + Cal.FormatDate(PValue) + "');aggiorna('"+PValue+"','"+Cal.Month+"','"+Cal.Year+"');\">" + PValue + "</td>"; }
		}
		else
