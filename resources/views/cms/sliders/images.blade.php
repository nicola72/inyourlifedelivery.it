            ...
            <div class="col-lg-5">
                <div class="ibox">
                    ...
                    <div class="ibox-title">
                        ...
                        <!-- Indietro -->
                        <a href="{{url('cms/sliders')}}" class="btn btn-w-m btn-primary">Sliders</a>
                        <!-- fine pulsante nuovo -->
                    ...
                    @if(!$limit_max_file)
                        <div class="ibox-content">
                            ...
                            <form action="{{url('cms/sliders/upload_images')}}" class="dropzone" id="dropzoneForm">
                                {{ csrf_field() }}
                                <input type="hidden" name="fileable_id" id="fileable_id" value="{{$slider->id}}" />
                                <div class="row">
                                    <div class="col-md-12">
                                        <div>
                                            <div class="fallback">
                    ...
                    <div id="sortable" class="col-md-12 sortable">
                        ...
                        <div id="{{$img->id}}" class="file-box" style="cursor: pointer">
                            <div class="file">
                                ...
                                <div class="image">
                                    <a href="{{$website_config['slider_dir'].$img->path}}"  data-gallery="">
                                        <img src="{{$website_config['slider_dir'].$img->path}}" alt="" class="img-fluid"  />
                                    </a>
                                </div>
